...
Dish _$DishFromJson(Map<String, dynamic> json) => Dish(
      ...
      pivot: json['pivot'] == null
          ? null
          : DishPivot.fromJson(json['pivot'] as Map<String, dynamic>),
      dish_options: (json['dish_options'] as List<dynamic>?)
      ...
      dishBranchStock: json['dishBranchStock'] == null
          ? null
          : DishBranchStock.fromJson(
              json['dishBranchStock'] as Map<String, dynamic>),
    );
...
Map<String, dynamic> _$DishToJson(Dish instance) => <String, dynamic>{
      ...
      'dish_options': instance.dish_options,
      'dishBranchStatus': instance.dishBranchStatus,
      'dishImages': instance.dishImages,
      'dishBranchStock': instance.dishBranchStock,
    };
