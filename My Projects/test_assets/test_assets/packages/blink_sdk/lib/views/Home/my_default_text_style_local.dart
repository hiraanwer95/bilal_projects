...
import 'package:blink_sdk/views/Home/inherited_widget_local.dart';
...
class MyDefaultTextStyle extends InheritedThemeLocal {
  /// Creates a default text style for the given subtree.
  ///
  /// Consider using [MyDefaultTextStyle.merge] to inherit styling information
  ...
  const MyDefaultTextStyle.fallback({ Key? key })
  ...
  static Widget merge({
    ...
    return Builder(
      builder: (BuildContext context) {
        final MyDefaultTextStyle parent = MyDefaultTextStyle.of(context);
  ...
  /// ```
  static MyDefaultTextStyle of(BuildContext context) {
    return context.dependOnInheritedWidgetOfExactType<MyDefaultTextStyle>() ?? const MyDefaultTextStyle.fallback();
  }
...
///    [Text] widgets.
class DefaultTextHeightBehavior extends InheritedThemeLocal {
...
class Text extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final MyDefaultTextStyle defaultTextStyle = MyDefaultTextStyle.of(context);
